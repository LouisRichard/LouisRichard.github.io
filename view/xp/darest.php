...
<span class="bg-text">"DAREST"</span>
    ...
    <div class="project-content">
      ...
      <p class="util-text">
        ...
        <span class="bracket-text">[Timespan]</span> FEB. 2025 - AUG. 2026<br>
        <span class="bracket-text">[Status]</span> <span style="color:#F00">OFFLINE</span>
      </p>

      <p class="mt-4">
        Experience aquired as a regular day job.<br/>
        I joined the IT Service Desk team for the client <a href="https://audemarspiguet.com/">Audemars Piguet</a>. The Service Desk is available 24/7 do so lvl 1 and 2 tech support on workstations and some specialized softwares.<br/>
        I worked on the phone and at the Service Desk counter in multiple offices, in the Vallée de Joux and Crissier.<br/>
        During my time, I've also worked remotely, sometimes during the night or very early mornings.<br/>
        Support was provided in both French and English to offices and boutiques across the world.<br/>
      ...
      <p class="util-text">
        ...
        Nimbus Luware call center client<br/>
